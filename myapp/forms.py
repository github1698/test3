...
class WorkorderForm(ModelForm):
    ...
    class Meta:
        model=Workorder
        fields=('requesting_unit','department','receiving_unit','date_received','completion_date','machine','completed')
        labels={
            'requesting_unit':'',
            'department':'',
            'receiving_unit':'',
...
class WorkorderFormAdmin(ModelForm):
    ...
    class Meta:
        model=Workorder
        fields=('requesting_unit','department','receiving_unit','date_received','completion_date','machine','item_used','manager','completed')
        labels={
            'requesting_unit':'',
            'department':'',
            'receiving_unit':'',
        ...
        widgets = {
            ...
            'manager':forms.Select(attrs={'class':'form-controlt','placeholder':' Manager'}),
            'attendees':forms.SelectMultiple(attrs={'class':'form-control','placeholder':'Attending Officer'}),
