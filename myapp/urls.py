...
urlpatterns = [
    ...
    path('finished_workorder',views.finished_workorder,name='finished-workorder'),
    path('unfinished_workorder',views.unfinished_workorder,name='unfinished-workorder'),
    #path('item_work',views.item_work,name='item-work'),
   # path('item_requisition',views.item_requisition,name='item-requisition'),
   # path('<int:year><str:month>/',views.index,name='home'),
    ...
    #path('add/', views.add_request, name='add-request'),  
    #path('request/<uuid:requisition_id>/', views.request_detail, name='request_detail'),  
